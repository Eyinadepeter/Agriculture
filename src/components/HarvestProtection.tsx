...
import HarvestSafe from "../assets/HarvestSafe.png";
...
const helpCards: HelpCard[] = [
  {
    icon: <img src={vector} alt="Safe Storage" className="feature-icon" />,
    title: "Store with Confidence",
    body: "Access safer storage options to help keep your produce fresh for longer.",
    dark: false,
  },
  {
    icon: <img src={framero} alt="Safe Storage" className="feature-icon" />,
  ...
  {
    icon: (
      <img src={reachBuyers} alt="Reach More Buyers" className="feature-icon" />
    ),
  ...
  {
    icon: (
      <img src={moveHarvest} alt="Move Your Harvest" className="feature-icon" />
    ),
...
export default function HarvestProtection() {
  ...
  <div className="relative rounded-xl overflow-visible right-15 ">
  <img
    src={harvestImage}
  ...
  <img
    ...
    className="absolute top-1/2 right-0 translate-x-1/2 -translate-y-1/2 w-28 md:w-36 z-20"
  />
</div>
      </div>
    </section>
